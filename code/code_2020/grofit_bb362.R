# this only pertains to bb362 run on 17 june 2020
# tobias mueller
...
gr <- cbind(gr, microbe="bb362", date="june 17")
...
write.csv(gr, "input/reformatted_bb362.csv", row.names = FALSE)
...
gr<-read.csv("input/reformatted_bb362.csv", na.strings=c(".", "NA"))
t<-read.csv("input/reformatted_bb362.csv", header=F)
times<-t[1,5:ncol(t)]
...
write.csv(parms, "outputs/bb362grofit_summary.csv")
...
ggsave("outputs/bb362plot.png", g, height = 8, width = 6, dpi = 600)
