...
#read in data 
d <- read.csv("input/2mM_h2o2_cleaned.csv")
...
gr <- cbind(gr, treatment="2mM h2o2", date="mar 9")
...
write.csv(gr, "input/2mM_h2o2_formatted.csv", row.names = FALSE)
...
gr<-read.csv("input/2mM_h2o2_formatted.csv", na.strings=c(".", "NA"))
t<-read.csv("input/2mM_h2o2_formatted.csv", header=F)
...
#decline 7, 12, 13, 14, 17, 22, 52, 55, 62, 64, 69, 76, 79, 83, 88
...
write.csv(parms, "output/2mM_h2o2_summary.csv")
